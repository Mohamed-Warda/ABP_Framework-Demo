...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a34227af-7882-48cb-8521-a469c5b83547
```

> `a34227af-7882-48cb-8521-a469c5b83547` is the password of the certificate, you can change it to any password you want.
